...
graph TD
    A["👑 Infinite Substance<br/>(សារធាតុអនន្ត — ព្រះ)<br/>Most reality"] -->|more reality than| B["🧍 Finite Substances<br/>(សារធាតុមានកំណត់)<br/>mind, body, stone"]
    B -->|more reality than| C["🎨 Modes<br/>(ម៉ូដ/លក្ខណៈ)<br/>shape, color, a single thought"]
...
%%{init: { "theme": "dark", "themeVariables": { "background": "#1e1e1e", "primaryTextColor": "#ffffff", "lineColor": "#a0a0a0", "actorBkg": "#2c3e50", "actorBorder": "#34495e", "actorTextColor": "#ffffff" }, "themeCSS": "svg { background-color: #1e1e1e !important; padding: 1rem !important; border-radius: 8px !important; } .edgeLabel rect { fill: #1e1e1e !important; } text, tspan { fill: #ffffff !important; }" } }%%
graph LR
    A["💡 Idea's objective reality<br/>(តថភាពវត្ថុវិស័យនៃគំនិត)"] -->|requires a cause with| B["⚙️ At least equal<br/>formal reality<br/>(តថភាពផ្លូវការយ៉ាងតិចស្មើ)"]
    B -->|otherwise| C["🚫 Something from nothing<br/>(អ្វីមួយកើតពីភាពទទេ)<br/>Impossible!"]
