...
graph TD
    P1["P1: I have an idea of God as<br/>infinite, perfect substance<br/>(ខ្ញុំមានគំនិតអំពីព្រះជាសារធាតុ<br/>គ្មានដែនកំណត់ និងល្អឥតខ្ចោះ)"] --> P3
    P2["P2: Causal Adequacy —<br/>a cause needs as much formal reality<br/>as the idea's objective reality<br/>(បុព្វហេតុត្រូវមានភាពពិត<br/>យ៉ាងហោចស្មើនឹងផល)"] --> P3
    P3["P3: That idea's objective reality<br/>exceeds my formal reality<br/>(ភាពពិតនៃគំនិតនេះ<br/>លើសភាពពិតរបស់ខ្ញុំ)"] --> C1
    P4["P4: I am only a finite substance<br/>(ខ្ញុំជាសារធាតុមានកំណត់)"] --> P3
    C1["C1: I cannot be its cause<br/>(ខ្ញុំមិនអាចជាបុព្វហេតុបានទេ)"] --> C2
    C2["✅ C2: An actually infinite being —<br/>God — exists<br/>(ព្រះពិតជាមានអត្ថិភាព)"]
