...
graph LR
    A["💡 Clear & Distinct Perception<br/>(ការយល់ឃើញច្បាស់លាស់ និងជាក់លាក់)"] -->|"used to prove<br/>(ប្រើដើម្បីបញ្ជាក់)"| B["✝️ God exists & does not deceive<br/>(ព្រះមានពិត និងមិនបោកប្រាស់)"]
    B -->|"needed to guarantee<br/>(ត្រូវការដើម្បីធានា)"| A
...
%%{init: { "theme": "dark", "themeVariables": { "background": "#1e1e1e", "primaryTextColor": "#ffffff", "lineColor": "#a0a0a0", "actorBkg": "#2c3e50", "actorBorder": "#34495e", "actorTextColor": "#ffffff" }, "themeCSS": "svg { background-color: #1e1e1e !important; padding: 1rem !important; border-radius: 8px !important; } .edgeLabel rect { fill: #1e1e1e !important; } text, tspan { fill: #ffffff !important; }" } }%%
graph TD
    A["💡 Present clear & distinct perception<br/>(ការយល់ឃើញច្បាស់ នៅពេលបច្ចុប្បន្ន)"] -->|"self-certifying — no God needed<br/>(ប្រាកដដោយខ្លួនឯង)"| B["✅ Cognitio<br/>(ការដឹងភ្លាមៗ)"]
    A -->|"proves (បញ្ជាក់)"| C["✝️ God, no deceiver<br/>(ព្រះមិនបោកប្រាស់)"]
    C -->|"guarantees recalled demonstrations<br/>(ធានាការរំលឹកភស្តុតាង)"| D["📚 Scientia<br/>(ចំណេះដឹងរឹងមាំ)"]
