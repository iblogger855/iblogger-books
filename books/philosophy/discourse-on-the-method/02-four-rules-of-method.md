...
- [៣. វិធានទី ៣ — ការរៀបចំលំដាប់លំដោលពីងាយទៅពិបាក (Rule of Synthesis)](#3)
...
graph TD
    ...
    C --> D["3. Synthesis & Order<br/>(ការរៀបចំពីងាយទៅពិបាក)"]
    D --> E["4. Complete Review<br/>(ការត្រួតពិនិត្យឡើងវិញ)"]
    E --> F["✅ Verified Truth<br/>(ការពិតដែលផ្ទៀងផ្ទាត់រួច)"]
...
<a id="3"></a>
## ៣. វិធានទី ៣ — ការរៀបចំលំដាប់លំដោលពីងាយទៅពិបាក (Rule of Synthesis)
